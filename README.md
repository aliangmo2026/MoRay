...
**对话工作台**：三栏布局、本地优先、快捷指令与光核输入台（在线演示为全新空环境，不含任何个人数据）

![对话工作台](docs/screenshots/01-chat.png)

| 提示词库（内置模板 / 变量 / A·B 测试） | 代码片段库（语法高亮 / 沙箱运行） |
|---|---|
| ![提示词库](docs/screenshots/02-prompts.png) | ![代码片段库](docs/screenshots/03-snippets.png) |
